...
#         Condition = {
#           StringEquals = {
#             "${data.terraform_remote_state.eks.outputs.aws_iam_openid_connect_provider_arn}:sub" : "system:serviceaccount:default:irsa-demo-sa"
#           }
#         }
...
#   }
#   depends_on = [aws_iam_openid_connect_provider.cluster, data.terraform_remote_state.eks]
# }
